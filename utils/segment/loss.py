...
class ComputeLoss:
    ...
    def __call__(self, preds, targets, masks):  # predictions, targets, model
        ...
        p, proto = preds
        bs, nm, mask_h, mask_w = proto.shape  # batch size, number of masks, leaf height, leaf width
        ...
        for i, pi in enumerate(p):  # layer index, layer predictions
            ...
            if n:
                ...
                marea = xywhn[i][:, 2:].prod(1)  # leaf width, height normalized
    ...
    def single_mask_loss(self, gt_mask, pred, proto, xyxy, area):
        """Calculates and normalizes single leaf loss for YOLOv5 between predicted and ground truth masks."""
