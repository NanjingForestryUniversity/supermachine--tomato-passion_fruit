...
class LoadImagesAndLabelsAndMasks(LoadImagesAndLabels):  # for training/testing
    def __init__(
        ...
        """Initializes the dataset with image, label, and leaf loading capabilities for training/testing."""
        super().__init__(
            path,
            img_size,
            batch_size,
...
def polygon2mask(img_size, polygons, color=1, downsample_ratio=1):
    ...
    # of loss calculation when leaf-ratio=1.
