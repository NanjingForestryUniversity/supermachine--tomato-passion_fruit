...
class Metrics:
    ...
    def mean_results(self):
        """Computes and returns the mean results for both box and leaf metrics by summing their individual means."""
    ...
    def get_maps(self, nc):
        """Calculates and returns the sum of mean average precisions (mAPs) for both box and leaf metrics for `nc`
        classes.
        """
    ...
    def ap_class_index(self):
        """Returns the class index for average precision, shared by both box and leaf metrics."""
