...
from pipe_utils.general import LOGGER, colorstr, cv2
from pipe_utils.loggers.clearml.clearml_utils import ClearmlLogger
from pipe_utils.loggers.wandb.wandb_utils import WandbLogger
from pipe_utils.plots import plot_images, plot_labels, plot_results
from pipe_utils.torch_utils import de_parallel
...
try:
    if RANK in {0, -1}:
        ...
        from pipe_utils.loggers.comet import CometLogger
